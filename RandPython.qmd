...
This presentation and accompanying materials are available on :link: [UCLA OARC GitHub Repository](https://github.com/ucla-oarc-hpc/H2HH_RAndPython)

You can view the slides in:

- :page_facing_up: PDF format - RAndPython.pdf
- :globe_with_meridians: HTML format: [Workshop Slides](https://ucla-oarc-hpc.github.io/H2HH_RAndPython)
